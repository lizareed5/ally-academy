    ...
    return (
        <div>
            <Menu left>
                ...
                <a id="home" className="menu-item" href="/terms">Terms</a>
                <a id="home" className="menu-item" href="/gendernyms">Gendernym Finder</a>
                <a id="home" className="menu-item" href="/profile">Profile</a>
                <a id="home" className="menu-item" href="/login">Login</a>
                <a id="home" className="menu-item" href="/signup">Signup</a>
            </Menu>
